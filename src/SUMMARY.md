...
- [Основы архитектуры компьютера, культура кода, ...]()
    ...
    - [Turing Complete](turingcomplete/turing_complete.md)
        ...
        - [Sandbox](turingcomplete/turingcomplete_sandbox.md)             
    ...
    - [Дискретная математика](discrete_mathematics/conclusion_4.md)
        ...
        - [Вероятность](discrete_mathematics/вероятность.md)
        - [Таблицы истинности](discrete_mathematics/таблицы_истинности.md)
        - [Задачки по программированию](programming_problems.md)
    - [Брайант Р. Э., О'Халларон Д. Р Компьютерные системы. Архитектура и программирование 2022](conclusion_7.md)
    - [Харольд Абельсон. Структура и интерпретация компьютерных программ (SICP) (первые 3 главы)](sicp.md)
        - [Глава 1. Построение абстракций с помощью процедур](sicp_сhapter_1.md)
...
- [Разное]()
  ...
  - [Разное](conclusion_40.md)

- [Личности](personalities.md)
