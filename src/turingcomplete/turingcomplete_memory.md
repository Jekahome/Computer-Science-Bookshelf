...
Только в случае если первый вход 1, обновите сохранённое значение.

Второй вход указывает какое значение нужно сохранить.
...
* Save — управляющий сигнал
* Value — значение, которое можно сохранить
