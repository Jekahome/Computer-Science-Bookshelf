...
* Стартовая секция и завершающая имеют общий алгоритм, с одним отличием - выход из секции. 
* Вторая с третьей это второй алгоритм последовательности шагов, оличаются тоже выходом из секции и зеркальным отражением.
